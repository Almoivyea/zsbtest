...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SW_GND_GPIO_Port, SW_GND_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, LCD_SDA_Pin|LCD_SCL_Pin|LCD_GND_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : SW_GND_Pin */
  GPIO_InitStruct.Pin = SW_GND_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SW_GND_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : LCD_VCC_Pin */
  GPIO_InitStruct.Pin = LCD_VCC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(LCD_VCC_GPIO_Port, &GPIO_InitStruct);
